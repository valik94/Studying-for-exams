...
journey
	...
	section Practitioner is registered
		...
		Practitioner writes notes, reads medical details and makes diagnosis on patient: 3: Practitioner, Patient
		Practitioner books an appointment with a patient using calendar and auto-notification sent by email to patient: 5: Practitioner, Patient
	...
	section Patients visits appointment
		...
		Practitioner updates latest health information and gracefully logs out of the application erasing session id: 2: Patient
```
